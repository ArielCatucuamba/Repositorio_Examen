        ...
        <>
            ...
            {sellers.length === 0 ? (
                ...
                <div className="px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pb-10">
                    {sellers.map((seller) => (
                        <div key={seller._id} className="w-full max-w-sm p-4 shadow-lg bg-white relative cursor-pointer hover:bg-gray-100 transition duration-200 rounded-lg flex flex-col" onClick={() => navigate(`/dashboard/orders/${seller._id}`)}>
                            {/* Imagen del vendedor */}
